...
def main():
    ...
    parser.add_argument("--category_filter", type=str, default=None, help="Comma-separated categories, e.g. Relation,Size,Orientation,Depth,Count")
    ...
    category_filter = [c.strip() for c in args.category_filter.split(",")] if args.category_filter else None
    ds = load_benchmark(
        BENCHMARK,
